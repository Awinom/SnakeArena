...
const GRID_COUNT_X = 10; // Количество клеток по ширине
const GRID_COUNT_Y = 10; // Количество клеток по высоте
let GRID_SIZE = 10; // Базовый размер клетки (будет масштабироваться)

// Настройки игры
const FPS = 5; // Чем меньше, тем медленнее скорость змейки
let score = 0;
let lastTime = 0;
let isPaused = false;
let touchStartX = 0;
